 ...
 */
final class Version20220802074919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list RENAME COLUMN owner TO owner_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3DC1A4597E3C61F9');
        $this->addSql('ALTER TABLE "shopping_list" RENAME COLUMN owner_id TO owner');
    }
}
